...
for subject in os.listdir(os.getcwd()):
    if subject.startswith(('C','F','N')):
        ...
        wb_img = '{subject}/downsampled/3ds_filtered_func_data.nii.gz'.format(subject=subject)
        thal_img = '{subject}/downsampled/3ds_B_thal_on_filtered_func_data.nii.gz'.format(subject=subject)
        ...
        img.to_filename(os.path.join(img_directory, 'not_fisherZ_3ds.nii.gz'))
        ...
        img.to_filename(os.path.join(img_directory, 'fisherZ_3ds.nii.gz'))
